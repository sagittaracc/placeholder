...
final class PlaceholderTest extends TestCase
{
    ...
    {
        $this->assertTrue((new PlaceholderHelper("something ? something"))->hasUnnamedPlaceholder());
    }
    public function testPlaceholder(): void
    {
        ...
        $this->assertEquals((new PlaceholderHelper("Object: ?"))->bind(['foo' => 'bar']), 'Object: {"foo":"bar"}');
